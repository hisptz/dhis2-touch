  ...
  getHelpContents() {
    let helpContent = [{
      ...
      "subMenu": [{
        ...
        "contents": "DHIS2 Touch allows sharing of data among Stakeholders for their monitoring, analysis, planning and decision making. Its features can be summarized using the classical definition of the system which comprises of input, process and output.",
        "subMenu": [{
          "id": "1.1.1",
          "name": "Input",
          "contents": "DHIS2 Touch provides user-friendly interface for users to enter data. The screens for data entry do imitate the paper forms. Essentially, this feature enables entering into the system HMIS data which is collected from Village/Mtaa. "
        }, {
          "id": "1.1.2",
          "name": "Process",
          "contents": "DHIS2 Touch automatically computes sums, indicators and checks the validity of the data to make sure the data entered reflects the reality on the ground. "
        }, {
          "id": "1.1.3",
          "name": "Output",
        ...
        "contents": "This section provides instructions and guidance on how to use DHIS 2 Touch app and how to navigate to its features",
        "subMenu": []
      }, {
        "id": "1.3",
      ...
      "contents": "This App is for offline aggregate data reporting at all levels. To enter data in the mobile App, click data entry in the App menu. then select organization unit, data set and period from data entry menu to get data entry form opened",
      "subMenu": [{
        "id": "2.1",
      ...
      "id": "4.0",
      "name": "Dashboard",
      "tags": "table charts visualization visualizer data dashboard dashboarditems",
      ...
      "contents": "Settings allow user to set up various options regarding mobile data app in the android device and the server. the following options can be changed via settings",
      "subMenu": [{
        "id": "5.1",
      ...
      "contents": "Sync allow user to send data from the mobile phone to the ministry server, update metadata and clear data stored in the mobile phonme that is used to collect data. under sync app, Upload data via SMS, Download Metadata and Clear Offline Data are performed as follows",
      "subMenu": [{
        "id": "6.1",
      ...
      }, {"id": "6.2", "name": "Upload Data Via internet", "contents": "Content coming soon."}, {
        "id": "6.3",
      ...
      }, {"id": "6.4", "name": "Download data", "contents": "Content coming soon."}, {
        "id": "6.5",
        "name": "Clear local data",
        "contents": "Clear Offline Data is an option that gives user to clear HMIS data values or events that are stored in the smartphone. This feature helps in empting storage space of the android phones once data have been synced to the main server. user needs to select Clear Offline Data among the listed options under Sync App. Tick Data values check box when aggregate data values are to be cleared, In case both Data values and Events are to be deleted from the smartphone, user needs to check both check boxes in the list. Press CLEAR DATA option to delete selected data in the smartphone "
      }, {"id": "6.6", "name": "Clear local metadata", "contents": "Content coming soon."}]
    }, {
      "id": "7.0",
      "name": "Managing utilities menu",
      "tags": "managing utilities menu about profile logout log out",
      "contents": "Utility menu has modules that allow user to view user profile, system information, configuration of some parameters and logout. This is the part where user can change some default system settings that came with an app after downloading.",
      "subMenu": [{
        "id": "7.1",
        "name": "About",
        "contents": "About menu allow user view various system and data information setup and exchange between mobile phone and server. Once user has pressed About button, he will be able to view various system information such as name of the App, Version number, aggregate data values and events synced to the server.",
        "subMenu": []
      }, {
        "id": "7.2",
        "name": "Profile",
        "contents": "Its for users to view their profile information as they are entered or updated in the DHIS2 system. Through profile user can see the assigned organization unit, roles, assigned programs, and assigned forms.",
        "subMenu": []
      }, {
        "id": "7.3",
        "name": "Logout",
