...
export class EventCaptureForm implements OnInit{
  ...
  constructor(public params:NavParams,public eventProvider :EventsProvider,public Program : ProgramsProvider,
              public toastCtrl: ToastController,public user : UserProvider,public actionSheetCtrl: ActionSheetController,
              public ProgramStageDataElements : ProgramStageDataElementsProvider,
              public ProgramStageSections: ProgramStageSectionsProvider,public navCtrl: NavController,
