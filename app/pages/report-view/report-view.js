...
*/
var ReportViewPage = (function () {
    function ReportViewPage(params, navCtrl, toastCtrl, user, appProvider, sqlLite, httpClient) {
        var _this = this;
        this.params = params;
    ...
    ReportViewPage.prototype.loadingSelectedReport = function () {
        var _this = this;
        ...
        this.sqlLite.getDataFromTableByAttributes(resource, attribute, attributeValue, this.currentUser.currentDatabase).then(function (selectedReportList) {
            _this.designContent = selectedReportList[0].designContent;
    ...
    ReportViewPage.prototype.setLoadingMessages = function (message) {
        this.loadingMessages.push(message);
    };
    ReportViewPage.prototype.setToasterMessage = function (message) {
    ...
    ReportViewPage.prototype.setStickToasterMessage = function (message) {
        var toast = this.toastCtrl.create({
            message: message,
...
exports.ReportViewPage = ReportViewPage;
